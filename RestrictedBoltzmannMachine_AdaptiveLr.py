# Gradually increase or decrease the learning rate and observe the results.
# References: https://www.cs.toronto.edu/~hinton/absps/guideTR.pdf
...
class RBM:
    ...
    def train(self, data, max_epochs=1000, learning_rate=0.01, learning_rate_decay=1, epsilon = 1E-3, m=1000, k=5):
...
if __name__ == '__main__':
    ...
    plt.legend(['No adaptation', 'Decreased learning rate', 'Increased learning rate'])
    plt.savefig('plot_adaptiveLr.png')

    lst = []
    generated1 = r.markovChain(10)
    generated2 = r.markovChain(10)
    generated3 = r.markovChain(10)
